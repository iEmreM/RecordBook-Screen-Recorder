...
namespace Captura
{
    ...
    {
        public RecorderParams(string filename, int FrameRate, FourCC Encoder, int Quality, int width, int height)
        {
            FileName = filename;
            ...
            Height = height;//Screen.PrimaryScreen.Bounds.Height;
            Width = width;// Screen.PrimaryScreen.Bounds.Width;
        }
